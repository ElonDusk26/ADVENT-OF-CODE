...
for row in range(4000000):
    listOfOverlappingIntervals = smartIntervalBasedCheckUnavailableSpots(row, coordinateLenData)
    if len(listOfOverlappingIntervals) > 1 and listOfOverlappingIntervals[0].upper > 0 and listOfOverlappingIntervals[1].lower < 4000000:
        print("x={} and y={} and tuning frequency:".format(listOfOverlappingIntervals[1].lower - 1, row))
        print((listOfOverlappingIntervals[1].lower - 1) * 4000000 + row)
        print("test")
        break

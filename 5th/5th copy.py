...
def extractItems(stringIn):
    return [subString[0] for subString in stringIn.split("[") if len(subString) > 1]
...
stackData = getFileAsList("5th/liteStack")

stack = importStack(stackData)

moveCommandList = getFileAsList("5th/liteCommands")
